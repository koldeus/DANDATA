 ...
 */
final class Version20251029131921 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user_articles (user_id INT NOT NULL, articles_id INT NOT NULL, INDEX IDX_5F50D5681EBAF6CC (articles_id), INDEX IDX_5F50D568A76ED395 (user_id), PRIMARY KEY(user_id, articles_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
